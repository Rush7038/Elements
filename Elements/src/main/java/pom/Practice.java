...
public class Practice {
	...
	@FindBy (xpath = "//a[@id='forbidden']") private WebElement forbidden;
	...
	@FindBy (xpath = "//button[@id=\"colorChange\"]") private WebElement colorChange;
    ...
    public void clickOnSimpleLink(WebDriver driver) {
		simpleLink.click();
    ...
    public void clickOnBrokenLink(WebDriver driver) {
    	WebDriverWait wait = new WebDriverWait(driver, Duration.ofMillis(2000));
    	wait.until(ExpectedConditions.visibilityOf(brokenLink));
    ...
    public void clickOnForbidden(WebDriver driver) {
        ((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView(true)", forbidden);	
		forbidden.click();
    }
    ...
    public void checkColor(WebDriver driver) {
	    String st = colorChange.getCssValue("color");
	    String c =Color.fromString(st).asHex();
